...
$routes->get('client/transfert-multiple', 'TransactionController::transfertMultiple', ['filter' => 'auth']);
$routes->post('client/transfert-multiple/effectuer', 'TransactionController::effectuerTransfertMultiple', ['filter' => 'auth']);
